    ...
    <section className="filter">
      ...
      >
        <h5
          ...
          className="text-base font-semibold text-gray-500 uppercase flex items-center my-1 dark:text-gray-400"
        >
          Filters
        </h5>
        <button
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="text-slate-700 dark:text-slate-100">
            <li className="mt-1 mb-5">
              <p className="font-semibold flex items-center my-1">Sort by</p>
            ...
            <li className="mt-1 mb-5">
              <span className="font-semibold flex items-center my-1">
                Rating
              </span>
              <div className="flex items-center my-1">
                <input
